<!-- @migration-task Error while migrating Svelte code: can't migrate `let { code, error, error_description, state } = data;` to `$state` because there's a variable named state.
